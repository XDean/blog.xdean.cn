...
- A: 通常来说，是的。只有两种情况并非如此
  1. 奖金数额恰好在“临界点”，详见下一条
  2. 综合所得低于免税额度(包括起征点，转向扣除等)

---

- Q: 年终奖数额变多，到手反而变少了，是真的吗？
- A: 是的。这是优惠税率的漏洞（一说为by design）。
  - 年终奖的税按年计算，而速算扣除数用月表计算，故在税档间隙处会出现递减的情况。
...
- Q: 十三薪应该选择并入年终奖吗？
- A: 通常来说，是的。只有两种情况例外
  1. 加上十三薪后会使得一次性所得超过“临界点”，这会导致额外的税收。
  2. 年终奖数额超过综合所得应税额，反而使得综合所得税档较低。
